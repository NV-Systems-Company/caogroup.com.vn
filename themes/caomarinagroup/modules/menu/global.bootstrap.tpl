...
<div class="navbar navbar-default navbar-static-top" role="navigation">
    ...
    <div class="collapse navbar-collapse" id="menu-site-default">
        <ul class="nav navbar-nav">
            <li><a class="home" title="{LANG.Home}" href="{THEME_SITE_HREF}"><em class="fa fa-lg fa-home font-28"></em><span class="visible-xs-inline-block"> {LANG.Home}</span></a></li>
            <!-- BEGIN: top_menu -->
            ...
            <!-- END: top_menu -->
			<li class="active pull-right"><a href="tel:+84976575768" class="font-20 line-height-1"><i class="pe-7s-call mr-10 font-28"></i>0976.57.57.68</a></li>
        </ul>
    </div>
</div>
