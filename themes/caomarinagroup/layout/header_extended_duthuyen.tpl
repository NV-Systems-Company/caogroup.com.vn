                ...
                <div id="header">
					<div class="left-ads">
                           <div class="widget sm-text-center">
							  ...
							  <a href="#" class="font-12 text-gray text-uppercase">Mail </a>
							  <h5 class="font-13 text-black m-0"> saleduthuyen@yourdomain.com</h5>
							</div>
                    </div>
                    <div class="logo text-center">
                        <a title="{SITE_NAME}" href="https://caogroup.com.vn/du-thuyen/"><img src="/uploads/logo_214_120.png" alt="{SITE_NAME}"></a>
                        <!-- BEGIN: site_name_h1 -->
                        <h1>{SITE_NAME}</h1>
                    ...
                    <div class="right-ads">
						<div class="widget sm-text-center">
							...
							<a href="#" class="font-12 text-gray text-uppercase">Trụ Sở</a>
							<h5 class="font-13 text-black m-0"> 82 đường 56,KDC Đông Thủ Thiêm,P Bình Trưng Đông,TP Thủ Đức </h5>
						</div>
                        [HEAD_RIGHT]
                    </div>
                </div>
