                ...
                <div id="header">
					<div class="left-ads">
                           <div class="widget sm-text-center">
							  ...
							  <h5 class="font-13 text-black m-0"> salebds@yourdomain.com</h5>
							</div>
                    </div>
                    <div class="logo text-center">
                        <a title="{SITE_NAME}" href="https://caogroup.com.vn/bat-dong-san/"><img src="{LOGO_SRC}" alt="{SITE_NAME}"></a>
                        <!-- BEGIN: site_name_h1 -->
                        <h1>{SITE_NAME}</h1>
                    ...
                    <div class="right-ads">
						<div class="widget sm-text-center">
							...
							<h5 class="font-13 text-black m-0"> 118 Mai Hắc Đế, P Lê Đại Hành, Q Hai Bà Trưng, Tp Hà Nội.</h5>
						</div>
                        [HEAD_RIGHT]
                    </div>
                </div>
