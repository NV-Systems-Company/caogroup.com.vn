                ...
                <div id="header">
					<div class="left-ads">
                           <div class="widget sm-text-center">
							  ...
							  <h5 class="font-13 text-black m-0"> noithat@yourdomain.com</h5>
							</div>
                    </div>
                    <div class="logo text-center">
                        <a title="{SITE_NAME}" href="https://caogroup.com.vn/shops/"><img src="{LOGO_SRC}" alt="{SITE_NAME}"></a>
                        <!-- BEGIN: site_name_h1 -->
                        <h1>{SITE_NAME}</h1>
                    ...
                    <div class="right-ads">
						<div class="widget sm-text-center">
							...
							<h5 class="font-13 text-black m-0">Số 8 Trường Sơn, Tân Bình, Hồ Chí Minh </h5>
						</div>
                        [HEAD_RIGHT]
                    </div>
                </div>
