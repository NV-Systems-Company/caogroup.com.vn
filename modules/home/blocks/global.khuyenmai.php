...
if (!nv_function_exists('tms_khuyenmai')) {
    /**
     * @param string $module
     ...
     * @return string
     */
    function tms_config_khuyenmai($module, $data_block, $lang_block)
    {
     ...
     * @return number
     */
    function tms_config_khuyenmai_submit($module, $lang_block)
    {
        global $nv_Request;
     ...
     * @return string
     */
    function tms_khuyenmai($block_config)
    {
        ...
        if (isset($site_mods[$mod_name])) {
            ...
            if (file_exists(NV_ROOTDIR . '/themes/' . $global_config['module_theme'] . '/modules/' . $mod_file . '/block.khuyenmai.tpl')) {
                $block_theme = $global_config['module_theme'];
            } elseif (file_exists(NV_ROOTDIR . '/themes/' . $global_config['site_theme'] . '/modules/' . $mod_file . '/block.khuyenmai.tpl')) {
                $block_theme = $global_config['site_theme'];
            } else {
                $block_theme = 'default';
            }

            $xtpl = new XTemplate('block.khuyenmai.tpl', NV_ROOTDIR . '/themes/' . $block_theme . '/modules/' . $mod_file);
...
if (defined('NV_SYSTEM')) {
    $content = tms_khuyenmai($block_config);
}
