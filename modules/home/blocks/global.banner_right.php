...
if (!nv_function_exists('tms_banner_right')) {
    /**
     * @param string $module
     ...
     * @return string
     */
    function tms_config_banner_right($module, $data_block, $lang_block)
    {
     ...
     * @return number
     */
    function tms_config_banner_right_submit($module, $lang_block)
    {
        global $nv_Request;
     ...
     * @return string
     */
    function tms_banner_right($block_config)
    {
        ...
        if (isset($site_mods[$mod_name])) {
            ...
            if (file_exists(NV_ROOTDIR . '/themes/' . $global_config['module_theme'] . '/modules/' . $mod_file . '/global.banner_right.tpl')) {
                $block_theme = $global_config['module_theme'];
            } elseif (file_exists(NV_ROOTDIR . '/themes/' . $global_config['site_theme'] . '/modules/' . $mod_file . '/global.banner_right.tpl')) {
                $block_theme = $global_config['site_theme'];
            } else {
                $block_theme = 'default';
            }

            $xtpl = new XTemplate('global.banner_right.tpl', NV_ROOTDIR . '/themes/' . $block_theme . '/modules/' . $mod_file);
...
if (defined('NV_SYSTEM')) {
    $content = tms_banner_right($block_config);
}
